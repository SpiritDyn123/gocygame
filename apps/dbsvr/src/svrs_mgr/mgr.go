...
func (mgr *svrsMgr) Start() (err error) {
	//注册消息
	global.DBSvrGlobal.GetMsgDispatcher().Register(ProtoMsg.EmMsgId_SVR_MSG_REGISTER_GAME,
...
func (mgr *svrsMgr) OnAccept(tcp_session *tcp.Session) {
	logic_session := session.CreateClientSession(tcp_session, global.DBSvrGlobal, &ProtoMsg.PbSvrBaseInfo{})
