...
func (*PbSvrRegisterLoginReqMsg) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*PbSvrRegisterLoginResMsg) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
